...
const Footer = () => {
  return (
    <footer className='bg-gray-200 p-10'>
      <div className='mx-auto p-8 border-4 border-white/30 rounded-lg container'>
        <div className='gap-8 grid grid-cols-1 md:grid-cols-4'>
          {/* About Section */}
          <div>
            <h2 className='mb-3 font-bold text-xl'>About Us</h2>
            <p className='text-sm'>
              Join our medical camp management system and empower health
              awareness by connecting organizers and participants for impactful
              events.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='mb-2 text-sm'>
              Stay updated with the latest camps and healthcare events.
            </p>
            <Input.Search
        ...
        <div className='mt-8 pt-4 border-white/30 border-t text-sm text-center'>
          © 2025 Medical Camp Management System. All rights reserved. Built with
          ❤️ by Jaber Hossain.
        </div>
      </div>
    </footer>
