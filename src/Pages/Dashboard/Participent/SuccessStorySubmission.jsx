...
const SuccessStorySubmission = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      axios.post('https://b10a12-server-side-developer-jaber.vercel.app/success-story', newStory)
      .then(()=>{
  ...
  return (
    <div className="bg-gray-100 p-8 min-h-screen">
      <div className="bg-[#1A8A83] shadow-lg py-10 rounded-lg text-white text-center">
        ...
        <p className="mt-2 text-lg">Your experience can inspire others to take action.</p>
      </div>
      ...
      <div className="bg-white shadow-md mx-auto mt-10 p-6 rounded-lg max-w-4xl">
        ...
        <button type="primary" className="bg-[#42bb76] mt-4 p-1 rounded-md w-full font-bold text-gray-700 text-xl" onClick={handleSubmit}>
          Submit Story
        </button>
      </div>
    </div>
